  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">Start here for all things CODE at <a href="https://www.una.edu" target="_blank">UNA</a> </p>
        <p class="lead">
...
<!-- Built from https://twitter.com/mdo cover template from https://getbootstrap.com/ https://getbootstrap.com/docs/4.0/examples/cover/-->